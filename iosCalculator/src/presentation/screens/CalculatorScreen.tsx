...
export const CalculatorScreen = () => {
  ...
  const { prevNumber, formula, buildNumber, toogleSign, clean, deleteOperation, divideOperation, multiplyOperation, subtractOperation, addOperation, calculateResult } = useCalculator();
      ...
      <View style={{ paddingHorizontal: 30, paddingBottom: 20 }}>
...

        {
          formula === prevNumber
            ...
            : <Text style={styles.subResult} adjustsFontSizeToFit numberOfLines={1} > {prevNumber} </Text>
        }
